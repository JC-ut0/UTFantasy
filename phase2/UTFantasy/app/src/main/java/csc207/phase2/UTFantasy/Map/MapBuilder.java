...
public class MapBuilder {
  ...
  public void buildTree() {
    ...
    for (int x = 6; x < 18; x++) { // tree block No.2 x: 5-17, y: 12, six trees
      ...
      highMap[6][13] = new UnitDraw(Icon.TREEIMAGE);
    }
    ...
    for (int x = 2; x < 25; x++) { // tree block No.4 x: 2-25, y: 30-33, 12*2 trees
      ...
      highMap[1][30] = new UnitDraw(Icon.TREEIMAGE);
      highMap[1][32] = new UnitDraw(Icon.TREEIMAGE);
    }
    ...
    for (int x = 2; x < 25; x++) { // block No.10 x: 2-25, y = 46, 12 tress
      ...
      highMap[1][46] = new UnitDraw(Icon.TREEIMAGE);
    }
    for (int y = 48; y < 53; y++) { // block No.11 x: 16, y: 48-53, three trees
      ...
      highMap[16][47] = new UnitDraw(Icon.TREEIMAGE);
    }
    ...
    for (int x = 8; x < 15; x++) { // block No.15 x: 8-15, y: 60, four trees
      ...
      highMap[8][59] = new UnitDraw(Icon.TREEIMAGE);
      highMap[14][59] = new UnitDraw(Icon.TREEIMAGE);
    }
    for (int x = 4; x < 25; x++) { // block No.17 x: 4-27, y = 66, 12 trees
      ...
      highMap[3][66] = new UnitDraw(Icon.TREEIMAGE);
    }
    for (int y = 52; y < 75; y++) { // block No.16 x: 2, y: 52-75, 12 trees
      ...
      highMap[1][52] = new UnitDraw(Icon.TREEIMAGE);
    }
    ...
    for (int y = 38; y < 55; y++) { // block No.24 x: 36, y: 38-55, nine trees
      ...
      highMap[37][38] = new UnitDraw(Icon.TREEIMAGE);
      highMap[37][54] = new UnitDraw(Icon.TREEIMAGE);
    }
    for (int y = 62; y < 71; y++) { // block No.27 x: 36, y: 62-71, five trees
      ...
      highMap[37][62] = new UnitDraw(Icon.TREEIMAGE);
      highMap[37][70] = new UnitDraw(Icon.TREEIMAGE);
    }
    ...
    for (int y = 74; y < 81; y++) { // block No.19 x: 8, y: 74-81, four trees
      ...
      highMap[8][73] = new UnitDraw(Icon.TREEIMAGE);
    }
    for (int y = 76; y < 93; y++) { // block No.29 x: 2-5, y: 76-93, 9*2 trees
      for (int x = 2; x < 5; x++) {
        ...
        highMap[2][75] = new UnitDraw(Icon.TREEIMAGE);
      }
      highMap[1][92] = new UnitDraw(Icon.TREEIMAGE);
    }
    ...
    for (int x = 6; x < 33; x++) { // block No.22 x: 6-33, y: 88-93, 14*3 trees
      ...
      highMap[5][88] = new UnitDraw(Icon.TREEIMAGE);
      highMap[5][92] = new UnitDraw(Icon.TREEIMAGE);
    }
    for (int y = 74; y < 83; y++) { // block No.20 x: 24, y: 74-83, four trees
      ...
      highMap[24][73] = new UnitDraw(Icon.TREEIMAGE);
    }
    ...
    for (int x = 2; x < 38; x++) { // block No.28 bottom block
      ...
      highMap[1][106] = new UnitDraw(Icon.TREEIMAGE);
    }
    for (int x = 20; x < 33; x++) { // block No.25 stack of trees
      ...
      highMap[32][93] = new UnitDraw(Icon.TREEIMAGE);
      highMap[20][93] = new UnitDraw(Icon.TREEIMAGE);
    }
  }
