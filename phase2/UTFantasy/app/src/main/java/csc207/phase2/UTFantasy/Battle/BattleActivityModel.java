...
public interface BattleActivityModel {
    ...
    /**
     * open the menu of choosing next action
     * either choose skill, open bag, choose pokemon or escape
     */
    void openMenu();
    ...
    /**
     * stop the animation of catching pokemon
     * called when pokemon is failed to be caught
     */
    void hideCatch();
