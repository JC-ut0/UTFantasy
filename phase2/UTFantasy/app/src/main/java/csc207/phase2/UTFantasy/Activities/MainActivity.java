...
public class MainActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    interactFight.setOnClickListener(
        new View.OnClickListener() {
          @Override
          public void onClick(View view) {
    ...
    interactPurchase.setOnClickListener(
        new View.OnClickListener() {
          @Override
          public void onClick(View view) {
            if (npc.canTrade()) {
              ...
              Toast.makeText(MainActivity.this, "You can't trade with this npc", Toast.LENGTH_LONG)
                  .show();
            }
          }
        });

    interactHeal.setOnClickListener(
        new View.OnClickListener() {
          @Override
          public void onClick(View view) {
            if (npc.canHeal()) {
              ...
              Toast.makeText(MainActivity.this, "All Pokemon are healed.", Toast.LENGTH_LONG)
                  .show();
            } else {
              Toast.makeText(MainActivity.this, "This npc can't heal you", Toast.LENGTH_LONG)
                  .show();
            }
          }
        });

    interactBack.setOnClickListener(
        new View.OnClickListener() {
          @Override
          public void onClick(View view) {
